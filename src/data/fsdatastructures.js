  ...
  insertRelationships = function (relationships) {
    ...
    for (const relationship of relationships) {
      ...
      if (relationship.facts[0].type == 'http://gedcomx.org/Marriage') {
        ...
        if (person1 && person2 && relationship.facts[0].date)
          person1.addMarriageDate(relationship.facts[0].date.original)
        if (person1 && person2 && relationship.facts[0].place)
          person1.addMarriagePlace(relationship.facts[0].place.original)
        if (person1 && person2 && relationship.facts[0].date)
          person2.addMarriageDate(relationship.facts[0].date.original)
        if (person1 && person2 && relationship.facts[0].place)
          person2.addMarriagePlace(relationship.facts[0].place.original)
      }
    }
  }
}
